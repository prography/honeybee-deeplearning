...
parser.add_argument("--style_image", type=float, default="monet", help="image for getting style")
parser.add_argument("--style_dir", type=float, default="monet", help="image folder for getting style")
